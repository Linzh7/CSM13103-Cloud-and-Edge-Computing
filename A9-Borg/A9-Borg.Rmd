...
# 3. The following contains a snippet of a C++ program. Can you compile the code and provide the size of the binary with a) static linking and then b) without static linking? What is the reason for the size difference? (0.5 points)
